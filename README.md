...
| <a name="input_kubernetes_agent_runner_image_repository"></a> [kubernetes\_agent\_runner\_image\_repository](#input\_kubernetes\_agent\_runner\_image\_repository) | Kubernetes Agent Runner image without the tag, e.g. "my-registry.io/humanitec/humanitec-runner" (optional). If omitted, defaults to the value defined in the runner chart values.yaml file | `string` | `null` | no |
| <a name="input_kubernetes_agent_runner_image_tag"></a> [kubernetes\_agent\_runner\_image\_tag](#input\_kubernetes\_agent\_runner\_image\_tag) | Kubernetes Agent Runner image tag (optional). If omitted, defaults to the value defined in the runner chart values.yaml file | `string` | `null` | no |
